...
# Podemos fazer a organização das palavras por frequencia utilizando a biblioteca (nltk)
# A biblioteca tem uma função chamada FreqDist().

livro = sherlock.txt
frequencia = nltk.FreqDist(livro)
